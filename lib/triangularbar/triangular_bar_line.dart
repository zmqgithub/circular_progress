...
class TriangularProgressLine extends StatefulWidget{
  ...
  final Color color;
  TriangularProgressLine({@required this.size, this.backgroundColor = Colors.grey, this.color = Colors.blue});
...
class _TriangularProgress extends State<TriangularProgressLine> with SingleTickerProviderStateMixin{
