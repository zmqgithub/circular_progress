...
class CircularProgresse extends StatefulWidget{
  ...
  final Color color;
  CircularProgresse({@required this.size, this.backgroundColor = Colors.grey, this.color = Colors.blue});
...
class _CircularProgress extends State<CircularProgresse> with SingleTickerProviderStateMixin{
...
class CircularCanvas extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint..shader = new LinearGradient(colors: [Colors.redAccent, Colors.yellow[700]]
